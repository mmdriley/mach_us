 ...
 * 	[91/10/19            dbg]
 * 
 * Revision 2.4  91/05/14  16:07:23  mrt
 ...
 * Control register
 */
#define	FPC_IM		0x0001		/* mask invalid operation
					   exception */
#define	FPC_DM		0x0002		/* mask denormalized operation
					   exception */
#define	FPC_ZM		0x0004		/* mask zero-divide exception */
#define	FPC_OM		0x0008		/* mask overflow exception */
#define	FPC_UM		0x0010		/* mask underflow exception */
#define	FPC_PM		0x0020		/* mask precision exception */
